            ...
            <div class="card h-100">
                ...
                <div class="card-body p-0">
                    ...
                    <table class="table mb-0">
                        <tbody>
                            <tr>
                                <td class="border-top-0 "> <img src="../assets/images/svg/browser-svg/chrome.svg" alt="Image"
                            ...
                            <tr>
                                <td> <img src="../assets/images/svg/browser-svg/firefox.svg" alt="Image" class="me-2"><span>Mozilla
                                        Firefox</span></td>
                                <td class="text-end  ">14.43%</td>

                            </tr>
                            <tr>
                                <td> <img src="../assets/images/svg/browser-svg/brave.svg" alt="Image" class="me-2"><span>Brave</span></td>
                                <td class="text-end  ">14.43%</td>

                            </tr>
                            <tr>
                                <td> <img src="../assets/images/svg/browser-svg/safari.svg" alt="Image" class="me-2"><span>Apple
                                        Safari</span></td>
                            ...
                            <tr>
                                <td> <img src="../assets/images/svg/browser-svg/ie.svg" alt="Image" class="me-2"><span>Internet Export</span>
                                </td>
                                <td class="text-end  ">6.21%</td>

                            </tr>
                            <tr>
                                <td> <img src="../assets/images/svg/browser-svg/opera.svg" alt="Image"
                            ...
                            <tr>
                                <td> <img src="../assets/images/svg/browser-svg/microsoft-edge.svg" alt="Image"
