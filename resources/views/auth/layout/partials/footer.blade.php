                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-footer-wrapper quick-link-wrap">
                        ...
                        <ul class="ft-link tmp-link-animation">
                            <li>
                                <a href="{{ route('portfolio.about') }}">About Me</a>
                            </li>
                            <li>
                                <a href="{{ route('portfolio.service') }}">Service</a>
                            </li>
                            <li>
                                <a href="{{ route('portfolio.blog') }}">Blog Post</a>
                            </li>
                            <li>
                                <a href="{{ route('portfolio.project') }}">Project</a>
                            </li>
                            <li>
