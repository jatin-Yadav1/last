...
<body oncontextmenu="return false">
  ...
  <img draggable="false" src="./assets/images/preloader.gif" alt="">
    ...
    @include('home.layout.partials.header')
    
    @yield('content')

    <section class="skills d-none" id="skills" style="display: none;">
    ...
    <section class="education d-none" style="display: none;">
    ...
    <section class="experience d-none" style="display: none;">
